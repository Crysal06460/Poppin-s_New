...
class CdiStep7Signatures extends StatefulWidget {
  final ContratCdiModel model;
  final Function(ContratCdiModel) onUpdate;

  const CdiStep7Signatures({super.key, required this.model, required this.onUpdate});

  @override
  CdiStep7SignaturesState createState() => CdiStep7SignaturesState();
}

class CdiStep7SignaturesState extends State<CdiStep7Signatures> {
        ...
        children: [
          ...
          if (approvalOk) ...[
            ...
            Container(
              ...
              child: const Text(
                'Lu et approuvé',
                style: TextStyle(fontFamily: 'Waltograph', fontSize: 20, color: Color(0xFF2D3436)),
              ),
            ),
          ],
