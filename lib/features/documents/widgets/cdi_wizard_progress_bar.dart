...
class CdiWizardProgressBar extends StatelessWidget {
  final int etapeCourante;
  final int etapesValidees;

  const CdiWizardProgressBar({super.key, required this.etapeCourante, required this.etapesValidees});

  static const List<String> _labels = [
    'Employeur', 'Salarié', 'Enfant', 'Horaires', 'Salaire', 'Repos & Fériés', 'Signatures',
  ];
