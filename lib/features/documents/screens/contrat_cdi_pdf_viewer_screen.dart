...
class ContratCdiPdfViewerScreen extends StatefulWidget {
  ...
  const ContratCdiPdfViewerScreen({
    super.key,
    this.model,
    this.pdfBytes,
  ...
  @override
  State<ContratCdiPdfViewerScreen> createState() => _ContratCdiPdfViewerScreenState();
}

class _ContratCdiPdfViewerScreenState extends State<ContratCdiPdfViewerScreen> {
  Uint8List? _bytes;
  String? _error;
  ...
  Future<void> _generateFromModel() async {
    try {
      final bytes = await ContratCdiPdfService().genererPdf(widget.model!);
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Contrat CDI généré et enregistré !',
